/* runcmd.h - Header of libruncmd.
   ...
   Copyright (c) 2017
   Francisco José Monaco <moanco@icmc.usp.br>
   Caio de Sá Lopes <caio.sa.lopes@usp.br>

   This file is part of kell 

   kell is free software: you can redistribute it and/or modify
